...
public class TableReference extends PsiReferenceBase<PsiElement> {
    ...
    public TableReference(@NotNull XmlAttributeValue element, TextRange textRange, boolean isDefinition) {
        super(element, textRange);
        this.tableKey = element.getValue();
    ...
    private XmlAttributeValue findTable(XmlElement startElement, String tableKey) {
        // 找到根元素（Form）
        ...
        return targetTable.getAttribute("Key").getValueElement();
    }
