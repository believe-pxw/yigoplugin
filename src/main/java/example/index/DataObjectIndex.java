...
// 宏名称索引
public class DataObjectIndex extends FileBasedIndexExtension<String, Void> {

    // 唯一的索引ID
    public static final ID<String, Void> KEY = ID.create("DataObjectIndex");
